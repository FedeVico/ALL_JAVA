 ...
 * DictionaryWeightedGraph(vertices=(a, b, c, d, e), edges=(WE(b,d,2),
 * WE(b,c,4), WE(a,d,7), WE(c,d,5), WE(a,b,3), WE(d,e,4), WE(c,e,6)))
 * kruskal: HashSet(WE(b,d,2),WE(b,c,4),WE(a,b,3),WE(d,e,4))
 * 
 * g2: 7 vertices y 11 aristas
 * DictionaryWeightedGraph(vertices=(a, b, c, d, e, f, g), edges=(WE(a,b,7),
 * WE(f,g,11), WE(d,f,6), WE(a,d,5), WE(e,f,8), WE(b,c,8), WE(c,e,5), WE(b,e,7),
 * WE(e,g,9), WE(b,d,9), WE(d,e,15)))
